...
const Hero = () => {
  ...
  return (
    <div className="hero-box">
      <h1 className="anime-title text-white">{t('Chainsaw Man')}</h1>
      <p className="hero-desc text-white">{t('Chainsaw Man Description')}</p>
      <div className="hero-btns mt-4">
        <a href="#" className="btn btn-primary btn-lg watch me-4 ">
          ...
          <span className="icon-text">{t('Watch Now')}</span>
        </a>
        <a href="#" className="btn btn-light btn-lg detail">
          ...
          <span className="icon-text">{t('Detail')}</span>
        </a>
      </div>
    </div>
  );
